...
import com.example.onboarding.domain.port.OnboardingPort;
import com.example.onboarding.domain.port.RegistrationResult;
...
public class OnboardingController implements OnboardingPort {
    ...
    public ResponseEntity<Void> handleInitiatePayment(@PathVariable UUID sessionId) {
        initiatePayment(new SessionId(sessionId));
